        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h3 class="text-lg font-bold mb-4">Periode: Semua Transaksi</h3>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="font-bold text-indigo-600">
                                            ({{ $jurnal->coa->kode_akun }}) {{ $jurnal->coa->nama_akun }}
                                        </span>
                                        <br>
                                        <span class="text-xs text-gray-500 italic">{{ $jurnal->keterangan }}</span>
                                    </td>
                                    <td class="px-6 py-4 text-right font-mono {{ $jurnal->debit > 0 ? 'text-gray-900 font-bold' : 'text-gray-300' }}">
                                        {{ $jurnal->debit > 0 ? number_format($jurnal->debit, 0, ',', '.') : '-' }}
                                    </td>
                                    <td class="px-6 py-4 text-right font-mono {{ $jurnal->kredit > 0 ? 'text-gray-900 font-bold' : 'text-gray-300' }}">
